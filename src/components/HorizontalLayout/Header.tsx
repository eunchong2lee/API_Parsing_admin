        ...
        <div className="d-flex">
          ...
          >
            <DropdownToggle className="btn header-item " caret tag="button">
              {" "}
              <span>Components</span> <i className="mdi mdi-chevron-down"></i>
            </DropdownToggle>
          ...
          >
            ...
            <DropdownMenu className="p-2 dropdown-megamenu">
              <Row>
                <Col>
                  <h5 className="font-size-14 mx-4 mt-2">
                    {props.t("Computers Accessories")}
                  </h5>
                  <Link className="dropdown-item" to="#!">
                    {props.t("Laptops Tablets")}
                  </Link>
                  <Link className="dropdown-item" to="#!">
                    {props.t("Desktop Computers")}
                  </Link>
                  <Link className="dropdown-item" to="#!">
                    {props.t("Networking Products")}
                  </Link>
                  <Link className="dropdown-item" to="#!">
                    {props.t("Monitors")}
                  </Link>
                  <Link className="dropdown-item" to="#!">
                    {props.t("Bags, Cases & Sleeves")}
                  </Link>
                  <Link className="dropdown-item" to="#!">
                    {props.t("Batteries")}
                  </Link>
                  <Link className="dropdown-item" to="#!">
                    {props.t("Charges Adapters")}
                  </Link>
                </Col>
                <Col>
                  <h5 className="font-size-14 ms-4 mt-2">
                    {props.t("Smartphones & Tablets")}
                  </h5>
                  <Link className="dropdown-item" to="#!">
                    {props.t("Apple iPhone")}
                  </Link>
                  <Link className="dropdown-item" to="#!">
                    {props.t("Android Smartphones")}
                  </Link>
                  <Link className="dropdown-item" to="#!">
                    {props.t("Phablets")}
                  </Link>
                  ...
                  <Link className="dropdown-item" to="#!">
                    {props.t("Android Tablets")}
                  </Link>
                  <Link className="dropdown-item" to="#!">
                    {props.t("Tablets with Keyboard")}
                  </Link>
                </Col>
                <Col>
                  <h5 className="font-size-14 ms-4 mt-2">
                    {props.t("Television & Video")}
                  </h5>
                  <Link className="dropdown-item" to="#!">
                    {props.t("TV Sets")}
                  </Link>
                  <Link className="dropdown-item" to="#!">
                    {props.t("Home Theater Systems")}
                  </Link>
                  <Link className="dropdown-item" to="#!">
                    {props.t("DVD Players & Recorders")}
                  </Link>
                  <Link className="dropdown-item" to="#!">
                    {props.t("DVD-VCR Combos")}
                  </Link>
                  <Link className="dropdown-item" to="#!">
                    {props.t("Projectors")}
                  </Link>
                  <Link className="dropdown-item" to="#!">
                    {props.t("Projection Screens")}
                  </Link>
                  <Link className="dropdown-item" to="#!">
                    {props.t("Satelite Television")}
                  </Link>
                </Col>
                <Col>
                  <h5 className="font-size-14 ms-4 mt-2">
                    {props.t("Cameras, Photo & Video")}
                  </h5>
                  <Link className="dropdown-item" to="#!">
                    {props.t("Point & Shoot Digital Cameras")}
                  </Link>
                  <Link className="dropdown-item" to="#!">
                    {props.t("DSLR Cameras")}
                  </Link>
                  <Link className="dropdown-item" to="#!">
                    {props.t("Mirrorless Cameras")}
                  </Link>
                  <Link className="dropdown-item" to="#!">
                    {props.t("Body Mounted Cameras")}
                  </Link>
                  <Link className="dropdown-item" to="#!">
                    {props.t("Camera Lenses")}
                  </Link>
                  <Link className="dropdown-item" to="#!">
                    {props.t("Video Studio")}
                  </Link>
                </Col>
                <Col>
                ...
                <Link className="notification-item text-reset" to="#!">
                  <div className="d-flex border-bottom align-items-center">
                    ...
                    <div className="flex-grow-1 ms-4">
                      <h6 className="mb-0">
                        Behance{" "}
                        <span className="badge bg-warning badge-pill ml-1">
                          Free
                        </span>
                      </h6>
                      <p className="font-size-12 text-muted mb-0">
                ...
                <Link className="notification-item text-reset" to="#!">
                  <div className="d-flex border-bottom align-items-center">
                    ...
                    <div className="flex-grow-1 ms-4">
                      <h6 className="mb-0">
                        Mail Chimp{" "}
                        <span className="badge bg-danger badge-pill ml-1">
                          Premium
                        </span>
                      </h6>
                      <p className="font-size-12 text-muted mb-0">
